...
export default async function WorkspacePage({ params }: WorkspacePageProps) {
  ...
  console.log('🔍 Buscando workspace com slug:', slug)
  ...
  // Get workspace by slug (case insensitive)
  ...
  console.log('🔍 Resultado da busca:', { workspace, error })

  if (error || !workspace) {
    console.error('❌ Workspace não encontrado:', error)
    return (
        ...
        <Card className="max-w-md">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-600 mb-4">
              Este workspace não existe ou você não tem acesso.
            </p>
